...
-keep class moe.koiverse.imagination.models.PersistQueue { *; }
-keep class moe.koiverse.imagination.models.PersistPlayerState { *; }
-keep class moe.koiverse.imagination.models.QueueData { *; }
-keep class moe.koiverse.imagination.models.QueueType { *; }
-keep class moe.koiverse.imagination.playback.queues.** { *; }
