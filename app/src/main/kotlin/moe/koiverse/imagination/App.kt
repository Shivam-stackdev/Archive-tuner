...
import moe.koiverse.imagination.extensions.*
import moe.koiverse.imagination.ui.screens.settings.ThemePalettes
import moe.koiverse.imagination.ui.theme.ThemeSeedPalette
import moe.koiverse.imagination.ui.theme.ThemeSeedPaletteCodec
...
import moe.koiverse.imagination.kugou.KuGou
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        Timber.plant(Timber.DebugTree())
        try {
            Timber.plant(moe.koiverse.imagination.utils.GlobalLogTree())
        } catch (_: Exception) {}
