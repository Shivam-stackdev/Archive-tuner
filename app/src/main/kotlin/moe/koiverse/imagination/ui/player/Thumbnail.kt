...
import moe.koiverse.imagination.canvas.ArchiveTuneCanvas
import moe.koiverse.imagination.canvas.CanvasArtwork
...
fun Thumbnail(
    ...
    LaunchedEffect(itemScrollOffset) {
        ...
        if (currentItem > currentMediaIndex && canSkipNext) {
            ...
            if (moe.koiverse.imagination.ui.screens.settings.DiscordPresenceManager.isRunning()) {
                try { moe.koiverse.imagination.ui.screens.settings.DiscordPresenceManager.restart() } catch (_: Exception) {}
            }
