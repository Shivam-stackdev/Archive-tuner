...
import moe.koiverse.imagination.constants.MaxCanvasCacheSizeKey
import moe.koiverse.imagination.constants.MaxImageCacheSizeKey
...
import moe.koiverse.imagination.extensions.tryOrNull
...
import moe.koiverse.imagination.ui.player.CanvasArtworkPlaybackCache
import moe.koiverse.imagination.ui.utils.backToMain
import moe.koiverse.imagination.ui.utils.formatFileSize
    ...
    LaunchedEffect(maxImageCacheSize) {
        if (maxImageCacheSize == 0) {
            coroutineScope.launch(Dispatchers.IO) {
                ...
                moe.koiverse.imagination.utils.ArtworkStorage.clear(context)
            }
        }
    }
